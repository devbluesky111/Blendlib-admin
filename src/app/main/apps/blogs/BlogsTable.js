...
function BlogsTable(props) {
	...
	async function handleDeselect() {
		const resp = await axios.post(Backend.URL + '/delete_blog', {ids: selected}, { withCredentials: true, headers: {"Access-Control-Allow-Origin": "*"} });
		if (resp.data.ids) {
			setLoading(true);
			init();
			setLoading(false);
	...
	function handleClick(item) {
		props.history.push(`/apps/blogs/posts/${item.id}`);
	}
